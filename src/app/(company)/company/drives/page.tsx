            ...
            {drives.map((drive) => {
              ...
              return (
                <div key={drive.id} className="i-card overflow-hidden">
                  ...
                  {isExpanded && drive.slots.length > 0 && (
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tfoot>
                            <tr className="bg-muted/20">
                              <td colSpan={3} className="p-2.5 text-xs font-semibold text-foreground">Total</td>
                              <td className="p-2.5 text-right">
                                <span className="text-sm font-bold text-foreground">{driveStudents}</span>
                              </td>
                            </tr>
                          </tfoot>
                        </table>
                  ...
                  {isExpanded && drive.slots.length === 0 && (
                    <div className="border-t border-border/50 p-5 text-center text-sm text-muted-foreground">
                      No slots have been allocated for this drive yet.
                    </div>
                  )}
                </div>
              );
