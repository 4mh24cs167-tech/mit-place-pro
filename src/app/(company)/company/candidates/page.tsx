            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  <th className="text-left py-3.5 px-5 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                    Candidate
                  </th>
                  <th className="text-center py-3.5 px-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                    CGPA
                  </th>
                  <th className="text-center py-3.5 px-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                    ATS
                    ...
                    >
                      ...
                      <td className="py-3 px-3 text-center">
                        <span className="text-xs font-medium">
                          {c.currentRound > 0 ? `R${c.currentRound}` : "—"}
                        </span>
                      </td>
                      <td className="py-3 px-3 text-center">
                        <span
                      ...
                      <td className="py-3 px-3 text-center">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          {c.finalResult !== "rejected" &&
                            c.finalResult !== "selected" && (
                              <>
                                <button
